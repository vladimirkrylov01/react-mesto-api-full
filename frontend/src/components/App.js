  ...
  return (
    <div className="root">
      <CurrentUserContext.Provider value={currentUser}>
        ...
        <AddPlacePopup active={!isAddPlacePopupOpen} onClose={closeAllPopups} onAddPlace={handleAddCard} />
        <EditAvatarPopup active={!isEditAvatarPopupOpen} onClose={closeAllPopups} onUpdateAvatar={handleUpdateAvatar} />
        <ImagePopup card={selectedCard} onClose={closeAllPopups} active={!isPreviewPopupOpen} />
        <InfoToolTip
